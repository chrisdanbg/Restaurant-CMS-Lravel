...
@section('adminContent')
    <div class="col-md-8 admin-panel">
        ...
        <h1 class="text-center mb-2">Създай нов продукт</h1>
       <form class="card p-5" action="{{ route('admin.createNew')}}" method="POST">
            <img class="rounded mx-auto d-block mb-1" id="badge" name="badge" src="{{asset('img/no-image.png')}}" alt="" width="35%">
            {{ csrf_field() }}
            <h5>Наименование</h5>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-5  ml-auto">
                    ...
                    <input type="number" class="form-control col-xs-10 ml-auto" id="price" name='price' value="" step=".01">
