...
<div class="row">
    ...
    <div class="admin-navi">
      <ul>
      <li class="admin-navi-li"><a href=" {{ route('homepage') }} "><i class="fa fa-home" aria-hidden="true"></i><span class="ml-2 text-white">Главна страница</span></a></li>
          <li class="admin-navi-li"><a href="#"><i class="fa fa-tasks" aria-hidden="true"></i><span class="ml-2 text-white">Меню</span></a></li>
